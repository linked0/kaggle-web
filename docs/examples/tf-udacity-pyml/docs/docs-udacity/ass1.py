...
print('Cleansed Validation data: ', valid_dataset_clean.shape, valid_labels_clean.shape)
print('Cleansed Test data: ', test_dataset_clean.shape, test_labels_clean.shape)
statinfo = os.stat(pickle_file)
print('compressed new pickle size: ', statinfo.st_size)

def convert(img):
    img = (img * 255.0) + 255.0/2
    return img